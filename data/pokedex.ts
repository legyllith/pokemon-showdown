export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	moiri:	{
		...
		name: "Moiri",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 33, atk: 33, def: 33, spa: 33, spd: 99, spe: 99},
		abilities: {0: "Oxymort"},
		heightm: 0.3,
		weightkg: 1.8,
		color: "White",
	...
	sacriau: {
		...
		name: "Sacriau",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 66, atk: 66, def: 66, spa: 66, spd: 138, spe: 138},
		abilities: {0: "Oxymort"},
		heightm: 1.1,
		weightkg: 5,
		color: "Purple",
	...
	astraleon: {
		...
		types: ["Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 95, def: 130, spa: 65, spd: 60, spe: 110},
		abilities: {0: "Water Absorb", H: "Horoscope"},
		heightm: 1,
		weightkg: 3,
		color: "Blue",
		prevo: "Eevee",
